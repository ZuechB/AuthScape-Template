    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentFieldCategory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_DocumentFieldCategory_DocumentFieldCategoryId",
                        column: x => x.DocumentFieldCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DnsRecordId = table.Column<long>(type: "bigint", nullable: false),
                    CompanyId = table.Column<long>(type: "bigint", nullable: false),
                    PrettyCSS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinifiedCSS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PrimaryButtonColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondaryButtonColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DnsDesignField", x => x.DnsRecordId);
                    table.ForeignKey(
                        name: "FK_DnsDesignField_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DnsDesignField_DnsRecords_DnsRecordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentFolders_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketMessages_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceDueDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    InvoiceToUserId = table.Column<long>(type: "bigint", nullable: false),
                    CompanyId = table.Column<long>(type: "bigint", nullable: true),
                    PaidById = table.Column<long>(type: "bigint", nullable: true),
                    WhenPaid = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Invoices_AspNetUsers_PaidById",
                        column: x => x.PaidById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoicePayments_Wallets_WalletId",
                        column: x => x.WalletId,
                        principalTable: "Wallets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DnsDesignField_CompanyId",
                table: "DnsDesignField",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentFolders_UploadedByUserId",
                table: "DocumentFolders",
                column: "UploadedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Documents_DocumentFieldCategoryId",
                table: "Documents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicePayments_WalletId",
                table: "InvoicePayments",
                column: "WalletId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketMessages_CreatedByUserId",
