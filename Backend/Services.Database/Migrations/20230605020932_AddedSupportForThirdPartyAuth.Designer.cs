...
namespace Services.Database.Migrations
{
    ...
    [Migration("20230605020932_AddedSupportForThirdPartyAuth")]
    partial class AddedSupportForThirdPartyAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.DocumentProcessing.Document_Field", b =>
                {
                    b.HasOne("Models.DocumentProcessing.DocumentFieldCategory", "Category")
                        .WithMany()
                        .HasForeignKey("DocumentFieldCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
